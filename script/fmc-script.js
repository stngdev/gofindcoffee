...
$(document).ready(function() {
	...
	function getCoffee(lat,long){
		$.ajax({
			type: 'GET',
			dataType: "json",
			url: 'https://api.foursquare.com/v2/venues/explore?client_id=KWKGYHXL2IGHDM2KVPEXUOJIABE3G1IW3W1SMB42HSS531BW&client_secret=0WYRHOQ0EQQDUT2V12SPGZ1TIFTRCNVPWVYRO23JXPM1U1J3&v=20130815&ll='+lat+','+long+'&llAcc=100000.0&radius=1000&section=coffee&venuePhotos=1&limit=20',
...
/*				for (var i=0; i<l;i++)
	...
	*/			
				...
				$.each(coffeePlaces, function(index, element){
				    ...
				    $('#location-content').prepend(template(context));
